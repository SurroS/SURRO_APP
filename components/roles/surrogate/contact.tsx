        ...
        <YStack gap="$8">
            <YStack gap="$4">
                ...
                <XStack alignItems="center" justifyContent="space-between" gap="$2">
                    ...
                    {/* add button */}
                    <TouchableOpacity>
                        <Ionicons name="add-circle" size={24} color="#0E0E55" />
                    </TouchableOpacity>
                </XStack>
            </YStack>
                ...
                <XStack alignItems="center" justifyContent="space-between" gap="$2">
                    ...
                    <XStack alignItems="center" flexWrap='wrap' gap="$2">
                        <XStack alignItems="center" gap="$2">
                            ...
                            <Text fontSize="$4" color="black">Instagram</Text>
                        </XStack>
                        <XStack alignItems="center" gap="$2">
                            <Ionicons name="logo-facebook" size={24} color="#000" />
                            <Text fontSize="$4" color="black">Facebook</Text>
                        </XStack>
                        <XStack alignItems="center" gap="$2">
                            <Ionicons name="logo-twitter" size={24} color="#000" />
                            <Text fontSize="$4" color="black">Twitter</Text>
                        </XStack>
                        <XStack alignItems="center" gap="$2">
                            <Ionicons name="logo-linkedin" size={24} color="#000" />
                            <Text fontSize="$4" color="black">LinkedIn</Text>
                        </XStack>
                    </XStack>
                    {/* add button */}
                    <TouchableOpacity>

...
const Section = ({ icon, title, children }: any) => (
  ...
  >
    <XStack alignItems="center" gap="$2" marginBottom="$2">
      {icon}
      <Text style={{ color: colors.text }} fontSize="$6" fontWeight="700">
        {title}
      </Text>
    </XStack>
...
export default function GetStartedScreen() {
  ...
  const renderSurrogateContent = () => (
    <>
      ...
      >
        <Text>Fill in accurate personal, medical, and lifestyle details.</Text>
        <Text>Incomplete profiles reduce your chances of being matched.</Text>
      </Section>
      ...
      >
        <Text>Submit valid ID and required documents.</Text>
        <Text>Verification builds trust and increases visibility.</Text>
      </Section>
      ...
      >
        <Text>Use a clear, recent, and friendly photo.</Text>
        <Text>Profiles with good photos get significantly more attention.</Text>
      </Section>
      ...
      >
        <Text>Choose compensation that reflects market expectations.</Text>
        <Text>Unrealistic amounts can delay matching.</Text>
      </Section>
      ...
      >
        <Text>Respond quickly to messages and requests.</Text>
        <Text>Active users are prioritized in recommendations.</Text>
      </Section>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FFF" }}>
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        <YStack gap="$4">
          <Text fontSize="$5" fontWeight="800" style={{ color: colors.text }}>
            {getTitle()}
          </Text>

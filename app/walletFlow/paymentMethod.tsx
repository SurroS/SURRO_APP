...
//   { id: "PAYSTACK", label: "Paystack", icon: require("@/assets/images/Paystack.png") },
...
const gateways: { id: PaymentGateway; label: string; icon: any }[] = [
  {
    id: "PAYSTACK",
    label: "Paystack",
    icon: require("@/assets/images/Paystack1.png"),
  },
];
          ...
          >
            <XStack alignItems="center" justifyContent="space-between" width="100%">
              <XStack alignItems="center" flex={1}>
                <Image
                  source={g.icon}
                  style={{ width: 30, height: 30, marginRight: 15, resizeMode: "contain" }}
                />
                <Text style={styles.label}>{g.label}</Text>
              </XStack>

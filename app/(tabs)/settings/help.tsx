...
const helpTopics: HelpTopic[] = [
  ...
  },
  {
    id: "payments",
    title: "Payments",
    icon: <MaterialCommunityIcons name="credit-card-outline" size={22} color="#1E1E80" />,
    route: "/help/payments",
  },
  {
    id: "getting-matched",
    title: "Getting matched",
    icon: <MaterialCommunityIcons name="account-group-outline" size={22} color="#1E1E80" />,
    ...
    <SafeAreaView style={styles.container}>
      ...
      <YStack alignItems="center" marginTop={40}>
        ...
        <TouchableOpacity style={styles.mailButton} activeOpacity={0.8}>
          {/* <Ionicons name="head" size={16} color="#1E1E80" /> */}
